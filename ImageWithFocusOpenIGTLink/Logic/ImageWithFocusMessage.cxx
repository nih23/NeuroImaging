...
#include "igtl_ImageWithFocus.h"

namespace igtl {
ImageWithFocusMessage::ImageWithFocusMessage() : ImageMessage() {
    m_SendMessageType = "MYIMAGE";
    m_ReceiveMessageType = "MYIMAGE";
}

ImageWithFocusMessage::~ImageWithFocusMessage() {}

int
ImageWithFocusMessage::CalculateContentBufferSize() {
    return GetSubVolumeImageSize() + IGTL_MYIMAGE_HEADER_SIZE;
}

int
ImageWithFocusMessage::PackContent() {
    AllocateBuffer();
...
int
ImageWithFocusMessage::UnpackContent() {
